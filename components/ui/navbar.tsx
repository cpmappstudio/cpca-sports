...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  const classes = clsx(
    // Base
    "relative flex min-w-0 items-center gap-3 rounded-lg p-2 text-left text-base/6 font-medium text-sidebar-foreground sm:text-sm/5",
    ...
    // Dark mode
    "dark:text-sidebar-foreground dark:*:data-[slot=icon]:fill-zinc-400",
