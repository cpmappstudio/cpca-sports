...
const TYPE_STYLES: Record<string, string> = {
    league: "text-purple-700 bg-purple-50 dark:text-purple-400 dark:bg-purple-950",
...
const STATUS_STYLES: Record<string, string> = {
    ...
    affiliated: "text-green-700 bg-green-50 dark:text-green-400 dark:bg-green-950",
...
export function createOrganizationColumns(t: Translator): ColumnDef<OrganizationRow>[] {
    return [
...

        {
            ...
            header: () => <div className="text-center">{t("organizations.clubs")}</div>,
            cell: ({ row }) => (
