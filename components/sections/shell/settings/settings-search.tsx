...
import { SETTINGS_ICON_MAP } from "@/lib/settings";
...
export function SettingsSearch({ basePath }: SettingsSearchProps) {
    ...
    const { query, results, search, reset, isSearching } = useSettingsSearch(basePath);
                ...
                <Command shouldFilter={false}>
                    ...
                    <CommandList>
                        ...
                        {results.length > 0 && (
                            <CommandGroup>
                                {results.map((result) => {
                                    const Icon = SETTINGS_ICON_MAP[result.iconName];
                                    return (
                                        <CommandItem
